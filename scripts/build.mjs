 ...
 *                                          Email / GitHub links and the menu bar (in the
...
const PAGES = {
    ...
    "resume.html": {
        description:
            "Vimal Vivegananda's education, experience, selected projects, extra-curricular, skills, languages and interests.",
        ogType: "website",
    },
...
const SOCIAL_LINKS = [
    ...
    {
        label: "GitHub",
        href: "https://github.com/vimal7890",
